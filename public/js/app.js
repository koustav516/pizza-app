...
//         }).join('');
//     }
//     function generateMarkup(total_orders) {
//         return total_orders.map(order => {
//             return `
//                 <tr>
...
//                                     ${ order.orderStatus
//                                         === 'ORDER PLACED' ? 'selected' : '' }>
//                                     Placed</option>
//                                 <option value="confirmed" ${ order.orderStatus
//                                     === 'confirmed' ? 'selected' : '' }>
//                                     Confirmed</option>
//                                 <option value="prepared" ${ order.orderStatus
//                                     === 'prepared' ? 'selected' : '' }>
//                                     Prepared</option>
//                                 <option value="delivered" ${ order.orderStatus
//                                     === 'delivered' ? 'selected' : '' }>
//                                     Delivered
//                                 </option>
//                                 <option value="completed" ${ order.orderStatus
//                                     === 'completed' ? 'selected' : '' }>
//                                     Completed
//                                 </option>
//                             </select>
...
function admin(socket) {
  ...
  function renderItems(items) {
    ...
    return parsedItems.map(function (menuItem) {
      return "\n                <p>".concat(menuItem.item.name, " - ").concat(menuItem.quantity, " pcs </p>\n            ");
    }).join('');
  }
...
/* harmony import */ var _stores__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./stores */ "./resources/js/stores.js");
...
addToCartBtn.forEach(function (btn) {
  btn.addEventListener('click', function (event) {
    var pizza = JSON.parse(btn.dataset.pizza); //coming from home.ejs
...
if (adminAreaPath.includes('admin')) {
  Object(_admin__WEBPACK_IMPORTED_MODULE_2__["admin"])(socket);
  socket.emit('join', 'adminRoom');
}

socket.on('orderUpdated', function (data) {
  var updatedOrder = _objectSpread({}, order); //Copy of order
...
var storeList = Object(_stores__WEBPACK_IMPORTED_MODULE_3__["allStores"])();

function generateList() {
  var ul = document.querySelector('.list');
  storeList.forEach(function (shop) {
...
function makePopupContent(shop) {
  return "\n    <div>\n        <h4>".concat(shop.properties.name, "</h4>\n        <p>").concat(shop.properties.address, "</p>\n        <div class=\"phone-number\">\n            <a href=\"tel:").concat(shop.properties.phone, "\">").concat(shop.properties.phone, "</a>\n        </div>\n    </div>\n  ");
}
...
var shopsLayer = L.geoJSON(storeList, {
...
function flyToStore(store) {
  var lat = store.geometry.coordinates[1];
  var lng = store.geometry.coordinates[0];
  ...
  setTimeout(function () {
    L.popup({
      closeButton: false,
      offset: L.point(0, -8)
    }).setLatLng([lat, lng]).setContent(makePopupContent(store)).openOn(myMap);
  }, 3000);
}
...
/*!********************************!*\
  !*** ./resources/js/stores.js ***!
  \********************************/
/*! exports provided: allStores */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "allStores", function() { return allStores; });
function allStores() {
  return [{
    "type": "Feature",
    "geometry": {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 3;
            return Object(_stripe_stripe_js__WEBPACK_IMPORTED_MODULE_1__["loadStripe"])('pk_test_51IkOhQSG0u3wOGkdyGBj7Q7FcI3qNbZlTjAft73N3ldpPzPUolUMdNyTSSY1xZ8xaPvmzZAI09VPJpnxiNneI9jm006VFwRQcC');
...
__webpack_require__(/*! C:\Users\Koustav's PC\Documents\pizza-app\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\Users\Koustav's PC\Documents\pizza-app\resources\scss\app.scss */"./resources/scss/app.scss");
